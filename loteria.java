...
public class loteria {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Para terminar el programa escribe 0 0 0");
       ...
       contador = new int[101]; //son 101 para considerar el cero 
        ...
        for(int i=1; i<=N; i++){
            for(int j=1; j<=C; j++){
                ...
                random=(int) Math.floor(Math.random()*(n-M+1)+M);
                
                //si no va a haber numero repetidos entonces 
              
                //el siguiente while es para asegurarnos que NO repitan números
                while(random ==aux){
                    random=(int) Math.floor(Math.random()*(n-M+1)+M);
                }
                contador[random]++;
